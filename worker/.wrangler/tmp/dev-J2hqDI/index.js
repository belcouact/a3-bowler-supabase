...
// .wrangler/tmp/bundle-6ZZJMG/checked-fetch.js
...
// .wrangler/tmp/bundle-6ZZJMG/strip-cf-connecting-ip-header.js
  ...
  async fetch(request, env, ctx) {
    ...
    if (request.method === "POST" && url.pathname === "/signup") {
      try {
        ...
        const userProfile = { ...data, id: userId, password: void 0 };
...
// .wrangler/tmp/bundle-6ZZJMG/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-6ZZJMG/middleware-loader.entry.ts
