import{c as N,Z as A,O as e,S as g,U as y,X as R,Q as j,ao as z}from"./index-BOSSAdGq.js";import{M}from"./MarkdownRenderer-8bkQwRXJ.js";import{A as v,T as O}from"./target-CQ_MY4mu.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const T=N("Copy",[["rect",{width:"14",height:"14",x:"8",y:"8",rx:"2",ry:"2",key:"17jyea"}],["path",{d:"M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2",key:"zix9uf"}]]),E=({isOpen:w,onClose:h,content:i,isLoading:l,onHideWhileLoading:k,groupPerformanceTableData:d})=>{const u=A();if(!w)return null;let a=null,o=!1;try{if(i&&!l){const t=i.replace(/```json/g,"").replace(/```/g,"").trim();a=JSON.parse(t),a&&a.executiveSummary&&Array.isArray(a.areasOfConcern)&&(o=!0)}}catch{o=!1}const b=d.length>0,S=()=>{if(o&&a){let t=`Executive Overview:
${a.executiveSummary}
