import{V as te,Y as se,r as c,O as e,a3 as N,S as G,ah as ae,X as ne,aa as H}from"./index-BHui7Ahz.js";import{M as re}from"./MindMap-CKAWvDcn.js";import{A as L}from"./alert-circle-DaA4bnhj.js";import"./zoom-out-BCjTh-Fe.js";import"./trash-2-CLMLu7Rn.js";const me=()=>{var E;const{id:K}=te(),{a3Cases:V,updateA3Case:m}=se(),t=V.find(s=>s.id===K),[x,w]=c.useState(""),[j,S]=c.useState(!1),[A,y]=c.useState(null),[C,k]=c.useState(null),[M,I]=c.useState(!1),[O,b]=c.useState(null);c.useEffect(()=>{t&&t.rootCause!==x&&w(t.rootCause||"")},[t]),c.useEffect(()=>{if(!(t!=null&&t.mindMapNodes))return;const s=t.mindMapNodes;if(s.length===0)return;const n=s.filter(a=>!a.parentId);let r="";const i=(a,o)=>{const h=s.filter(l=>l.parentId===a);h.sort((l,d)=>l.y-d.y);for(const l of h){const d="  ".repeat(o);r+=`${d}- ${l.text}
