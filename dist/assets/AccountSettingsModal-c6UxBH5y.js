import{c as ke,aE as Be,Y as Ue,W as We,r,O as e,X as Ge,aF as qe,aG as Se,aH as B}from"./index-D2Dup-6N.js";import{generateAIContext as Ze,generateComprehensiveSummary as Je}from"./aiService-BdGNG9_S.js";import{L as _,M as Ye}from"./mail-CmjmdyW-.js";import{C as Ve}from"./check-CvKkAeXk.js";/**
...
`,c+=`----- | ------ | ------------ | ------------- | ------------- | ---------- | --------------------------
`,l.forEach(n=>{const x=n.latestMet===null||!n.latestActual?"—":n.latestActual,v=n.fail2?"Failing":"—",w=n.fail3?"Failing":"—",s=n.fail2||n.fail3?n.linkedA3Count===0?"0":String(n.linkedA3Count):"—",k=n.achievementRate!=null?`${n.achievementRate.toFixed(0)}%`:"—";c+=`${n.groupName} | ${n.metricName} | ${x} | ${v} | ${w} | ${s} | ${k}
`}),c+=`
...
</html>`,Ie=(t,l)=>{try{const d=t.replace(/```json/g,"").replace(/```/g,"").trim(),i=JSON.parse(d);if(!i||!i.executiveSummary||!Array.isArray(i.areasOfConcern))return"";const c=s=>s.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"),n=c(i.executiveSummary),x=i.a3Summary&&i.a3Summary.trim()!==""?`<section class="card card-a3">
