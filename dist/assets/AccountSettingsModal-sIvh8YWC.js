import{c as te,aG as pt,Z as bt,Y as xt,r as l,O as e,X as Je,aH as k,aI as gt,aJ as Ye}from"./index-CdVZk77k.js";import{generateAIContext as yt,generateComprehensiveSummary as vt}from"./aiService-C_4rO4X0.js";import{L as pe}from"./lock-CzSfMqDV.js";import{C as jt}from"./check-D8q4NAcP.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ve=te("Repeat",[["path",{d:"m17 2 4 4-4 4",key:"nntrym"}],["path",{d:"M3 11v-1a4 4 0 0 1 4-4h14",key:"84bu3i"}],["path",{d:"m7 22-4-4 4-4",key:"1wqhfi"}],["path",{d:"M21 13v1a4 4 0 0 1-4 4H3",key:"1rx37r"}]]),Mt=({isOpen:u,onClose:se,mode:h="account"})=>{const{user:r,refreshUser:be}=pt(),c=bt(),{bowlers:ae,a3Cases:q,selectedModel:Ke,dashboardSettings:p,setDashboardSettings:E,dashboardMarkdown:Qe,dashboardTitle:Xe,dashboardMindmaps:_e,activeMindmapId:et}=xt(),[j,Z]=l.useState("password"),[z,P]=l.useState(!1),[O,xe]=l.useState(!1),[B,ge]=l.useState(!1),[J,ye]=l.useState(!1),[re,ve]=l.useState(""),[le,je]=l.useState(""),[we,Se]=l.useState(""),[Ne,ke]=l.useState(""),[Ce,Ae]=l.useState("China"),[Ee,Me]=l.useState("SZFTZ"),[Fe,Pe]=l.useState("GBS"),[H,De]=l.useState(!0),[w,ne]=l.useState(""),[b,oe]=l.useState(""),[g,Y]=l.useState(""),[ie,tt]=l.useState(""),[D,L]=l.useState(null),[y,Te]=l.useState("weekly"),[T,$e]=l.useState(1),[$,Re]=l.useState(1),[G,Ie]=l.useState("08:00"),[V,ce]=l.useState(""),[K,ze]=l.useState(!1),[Q,Oe]=l.useState(!1),[m,de]=l.useState("autoSummary"),[X,Be]=l.useState(!1),[U,He]=l.useState(""),[C,Le]=l.useState(!1),[M,ue]=l.useState("schedule"),[R,_]=l.useState([]),[me,Ge]=l.useState(!1),[st,Ue]=l.useState(null),[S,I]=l.useState([]),[ee,We]=l.useState(!1);l.useEffect(()=>{r&&(ke(r.role||""),Ae(r.country||"China"),Me(r.plant||"SZFTZ"),Pe(r.team||"GBS"),De(r.isPublicProfile!==void 0?r.isPublicProfile:!0))},[r,u]),l.useEffect(()=>{if(!u){ze(!1),Oe(!1),Be(!1),ue("schedule"),_([]),I([]),ce("");return}if(K)return;const t=p.emailSchedule;t&&((t.frequency==="weekly"||t.frequency==="monthly")&&Te(t.frequency),typeof t.dayOfWeek=="number"&&$e(t.dayOfWeek),typeof t.dayOfMonth=="number"&&Re(t.dayOfMonth),t.timeOfDay&&Ie(t.timeOfDay),typeof t.stopDate=="string"&&ce(t.stopDate)),ze(!0)},[u,p.emailSchedule,K]),l.useEffect(()=>{if(!u||Q)return;const t=p.emailDefaults||{};w||(typeof t.recipients=="string"&&t.recipients.trim()!==""?ne(t.recipients):r&&r.email&&ne(r.email)),!b&&typeof t.subject=="string"&&t.subject.trim()!==""&&oe(t.subject),Oe(!0)},[u,p,Q,w,b,r]),l.useEffect(()=>{u&&(h==="email"?Z("email"):h==="account"&&j==="email"&&Z("password"))},[u,h,j]),l.useEffect(()=>{if(!u||X)return;const t=p.emailConsolidate||{};typeof t.tags=="string"&&He(t.tags),typeof t.enabled=="boolean"&&Le(t.enabled),Be(!0)},[u,p,X]),l.useEffect(()=>{u&&K&&E(t=>{const n=t.emailSchedule||{},s=typeof n.timezoneOffsetMinutes=="number"?n.timezoneOffsetMinutes:new Date().getTimezoneOffset();return{...t,emailSchedule:{...n,frequency:y,dayOfWeek:y==="weekly"?T:void 0,dayOfMonth:y==="monthly"?$:void 0,timeOfDay:G,stopDate:V||void 0,timezoneOffsetMinutes:s}}})},[y,T,$,G,V,u,K]),l.useEffect(()=>{u&&Q&&E(t=>({...t,emailDefaults:{...t.emailDefaults||{},recipients:w,subject:b}}))},[w,b,u,Q,E]),l.useEffect(()=>{u&&X&&E(t=>({...t,emailConsolidate:{...t.emailConsolidate||{},enabled:C,tags:U}}))},[C,U,u,X,E]),l.useEffect(()=>{u&&(g||p.latestSummaryForEmail&&(Y(p.latestSummaryForEmail),p.latestSummaryHtmlForEmail?L(p.latestSummaryHtmlForEmail):L(null)))},[u,p.latestSummaryForEmail,g]),l.useEffect(()=>{u&&(b||oe("Monthly A3 / Bowler Summary"))},[u,b]),l.useEffect(()=>{if(!u||h!=="email"||M!=="active"||!r||!r.username)return;let t=!1;return(async()=>{Ge(!0);try{const n=await k.listScheduledEmails(r.username);if(t)return;const s=Array.isArray(n.jobs)?n.jobs:[];s.sort((i,d)=>i.sendAt===d.sendAt?i.id.localeCompare(d.id):i.sendAt-d.sendAt),_(s)}catch(n){t||c.error(n.message||"Failed to load active schedules")}finally{t||Ge(!1)}})(),()=>{t=!0}},[u,h,M,r,c]);const at=async()=>{if(le!==we){c.error("New passwords don't match");return}if(!re){c.error("Please enter current password");return}P(!0);try{await Ye.changePassword({username:r==null?void 0:r.username,oldPassword:re,newPassword:le}),c.success("Password updated successfully"),ve(""),je(""),Se("")}catch(t){c.error(t.message||"Failed to update password")}finally{P(!1)}},rt=async()=>{P(!0);try{await Ye.updateProfile({username:r==null?void 0:r.username,role:Ne,profile:{country:Ce,plant:Ee,team:Fe,isPublic:H}}),c.success("Profile updated successfully");try{await be()}catch(t){console.warn("Background refresh failed:",t)}}catch(t){c.error(t.message||"Failed to update profile")}finally{P(!1)}},lt=async()=>{P(!0);try{await be(!0),c.success("Profile reloaded")}catch{c.error("Failed to reload profile")}finally{P(!1)}},nt=async t=>{if(!r||!r.username){c.error("You must be logged in to cancel scheduled emails");return}Ue(t.id);try{if(await k.cancelScheduledEmail(r.username,t.id),t.mode==="autoSummary"){const s={...p};"emailSchedule"in s&&delete s.emailSchedule,E(s);const i={...s,emailDefaults:{...s.emailDefaults||{},recipients:w,subject:b},emailConsolidate:{...s.emailConsolidate||{},enabled:C,tags:U}};await fe(i),c.success("Auto summary schedule cancelled")}else c.success("Scheduled email cancelled");const a=await k.listScheduledEmails(r.username),n=Array.isArray(a.jobs)?a.jobs:[];n.sort((s,i)=>s.sendAt===i.sendAt?s.id.localeCompare(i.id):s.sendAt-i.sendAt),_(n),I(s=>s.filter(i=>i!==t.id))}catch(a){c.error(a.message||"Failed to cancel scheduled email")}finally{Ue(null)}},ot=t=>{I(a=>a.includes(t)?a.filter(n=>n!==t):[...a,t])},it=()=>{if(S.length===R.length){I([]);return}I(R.map(t=>t.id))},ct=async()=>{if(!r||!r.username){c.error("You must be logged in to cancel scheduled emails");return}if(S.length===0){c.error("Please select at least one scheduled email to cancel");return}We(!0);try{for(const n of S)try{await k.cancelScheduledEmail(r.username,n)}catch(s){c.error(s.message||`Failed to cancel scheduled email (${n})`)}const t=await k.listScheduledEmails(r.username),a=Array.isArray(t.jobs)?t.jobs:[];a.sort((n,s)=>n.sendAt===s.sendAt?n.id.localeCompare(s.id):n.sendAt-s.sendAt),_(a),I([]),c.success("Selected scheduled emails cancelled")}finally{We(!1)}},qe=()=>{const t=p,a=t.emailSchedule||{},n=typeof a.timezoneOffsetMinutes=="number"?a.timezoneOffsetMinutes:new Date().getTimezoneOffset();return{...t,emailDefaults:{...t.emailDefaults||{},recipients:w,subject:b},emailConsolidate:{...t.emailConsolidate||{},enabled:C,tags:U},emailSchedule:{...a,frequency:y,dayOfWeek:y==="weekly"?T:void 0,dayOfMonth:y==="monthly"?$:void 0,timeOfDay:G,stopDate:V||void 0,timezoneOffsetMinutes:n}}},fe=async t=>{if(!(!r||!r.username))try{await k.saveData(ae,q,r.username,Qe,Xe,_e,et,t)}catch(a){console.error("Failed to persist email settings to backend",a)}},dt=(t,a)=>{try{const n=t.replace(/```json/g,"").replace(/```/g,"").trim(),s=JSON.parse(n);if(!s||!s.executiveSummary)return t;let i=`Executive Overview:
${s.executiveSummary}
