import{c as N,Y as A,O as e,S as g,Q as y,X as R,am as z}from"./index-D2Dup-6N.js";import{M}from"./MarkdownRenderer-C3qh4P7S.js";import{a as j,A as v,T as O}from"./target-soOzrk-8.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const T=N("Copy",[["rect",{width:"14",height:"14",x:"8",y:"8",rx:"2",ry:"2",key:"17jyea"}],["path",{d:"M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2",key:"zix9uf"}]]),U=({isOpen:w,onClose:h,content:i,isLoading:l,onHideWhileLoading:k,groupPerformanceTableData:d})=>{const u=A();if(!w)return null;let a=null,o=!1;try{if(i&&!l){const t=i.replace(/```json/g,"").replace(/```/g,"").trim();a=JSON.parse(t),a&&a.executiveSummary&&Array.isArray(a.areasOfConcern)&&(o=!0)}}catch{o=!1}const b=d.length>0,S=()=>{if(o&&a){let t=`Executive Overview:
${a.executiveSummary}
