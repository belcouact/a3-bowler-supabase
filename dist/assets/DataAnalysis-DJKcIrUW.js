import{c as F,V as K,Y as M,r as t,O as e,a3 as g,S as E,X as q}from"./index-BeqLq4-N.js";import{I as J}from"./ImageCanvas-D-37p0t1.js";import{A as z}from"./alert-circle-CDft91Fb.js";/**
 * @license lucide-react v0.330.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const $=F("BarChart3",[["path",{d:"M3 3v18h18",key:"1s2lah"}],["path",{d:"M18 17V9",key:"2bz60n"}],["path",{d:"M13 17V5",key:"1frdt8"}],["path",{d:"M8 17v-3",key:"17ska0"}]]);/**
 * @license lucide-react v0.330.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const L=F("Route",[["circle",{cx:"6",cy:"19",r:"3",key:"1kj8tv"}],["path",{d:"M9 19h8.5a3.5 3.5 0 0 0 0-7h-11a3.5 3.5 0 0 1 0-7H15",key:"1d8sl"}],["circle",{cx:"18",cy:"5",r:"3",key:"gq8acd"}]]),Q=()=>{var O;const{id:H}=K(),{a3Cases:R,updateA3Case:u}=M(),s=R.find(a=>a.id===H),n=t.useRef(null),[x,p]=t.useState([]),[b,f]=t.useState(500),[y,v]=t.useState(!1),[j,w]=t.useState(null),[N,A]=t.useState(null),[k,S]=t.useState(!1),[C,h]=t.useState(null),[P,I]=t.useState(null);t.useEffect(()=>{if(s){s.dataAnalysisImages&&JSON.stringify(s.dataAnalysisImages)!==JSON.stringify(x)&&p(s.dataAnalysisImages||[]),s.dataAnalysisCanvasHeight&&s.dataAnalysisCanvasHeight!==b&&f(s.dataAnalysisCanvasHeight);const a=s.dataAnalysisObservations||"";n.current&&n.current.value!==a&&(n.current.value=a)}},[s==null?void 0:s.id]);const T=a=>{p(a),s&&u({...s,dataAnalysisImages:a})},D=a=>{f(a),s&&u({...s,dataAnalysisCanvasHeight:a})},V=()=>{if(s&&n.current){const a=n.current.value;a!==s.dataAnalysisObservations&&u({...s,dataAnalysisObservations:a})}},Y=async()=>{var r,l,o,d;if(!(s!=null&&s.problemStatement))return;const a=((r=n.current)==null?void 0:r.value)||s.dataAnalysisObservations||"";if(a.trim()){v(!0),A(null),w(null);try{const c=[{role:"system",content:`You are an expert troubleshooting coach, skilled in many areas.
