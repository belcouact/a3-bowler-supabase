import{c as J,W as V,Z as W,al as M,r,O as e,a4 as p,S as R,X,am as D}from"./index-Bt8dNItE.js";import{I as Z}from"./ImageCanvas-eahUsgvd.js";import{A as T}from"./alert-circle-CEwwsv4B.js";import{B as Q}from"./bar-chart-3-BgYekKb5.js";/**
 * @license lucide-react v0.330.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const _=J("Route",[["circle",{cx:"6",cy:"19",r:"3",key:"1kj8tv"}],["path",{d:"M9 19h8.5a3.5 3.5 0 0 0 0-7h-11a3.5 3.5 0 0 1 0-7H15",key:"1d8sl"}],["circle",{cx:"18",cy:"5",r:"3",key:"gq8acd"}]]),ne=()=>{var H;const{id:F}=V(),{a3Cases:z,updateA3Case:u,isLoading:L}=W(),{user:n}=M(),s=z.find(a=>a.id===F),l=r.useRef(null),[b,x]=r.useState([]),[v,f]=r.useState(500),[j,w]=r.useState(!1),[A,N]=r.useState(null),[S,k]=r.useState(null),[I,C]=r.useState(!1),[P,g]=r.useState(null),[O,E]=r.useState(null),U=async a=>!s||!(n!=null&&n.username)?URL.createObjectURL(a):(await D.uploadA3Image(n.username,s.id,a)).url;r.useEffect(()=>{if(s){s.dataAnalysisImages&&JSON.stringify(s.dataAnalysisImages)!==JSON.stringify(b)&&x(s.dataAnalysisImages||[]),s.dataAnalysisCanvasHeight&&s.dataAnalysisCanvasHeight!==v&&f(s.dataAnalysisCanvasHeight);const a=s.dataAnalysisObservations||"";l.current&&l.current.value!==a&&(l.current.value=a)}},[s==null?void 0:s.id]),r.useEffect(()=>{if(!s||!(n!=null&&n.username)||Array.isArray(s.dataAnalysisImages)&&s.dataAnalysisImages.length>0)return;let o=!1;return(async()=>{try{const t=await D.loadA3Detail(n.username,s.id);if(!t||!t.success||o)return;const d={...s};let i=!1;Array.isArray(t.dataAnalysisImages)&&(x(t.dataAnalysisImages),d.dataAnalysisImages=t.dataAnalysisImages,i=!0),typeof t.dataAnalysisCanvasHeight=="number"&&(f(t.dataAnalysisCanvasHeight),d.dataAnalysisCanvasHeight=t.dataAnalysisCanvasHeight,i=!0),i&&u(d)}catch{}})(),()=>{o=!0}},[s==null?void 0:s.id,n==null?void 0:n.username,u]);const Y=a=>{x(a),s&&u({...s,dataAnalysisImages:a})},$=a=>{f(a),s&&u({...s,dataAnalysisCanvasHeight:a})},B=()=>{if(s&&l.current){const a=l.current.value;a!==s.dataAnalysisObservations&&u({...s,dataAnalysisObservations:a})}},G=async()=>{var o,m,t,d;if(!(s!=null&&s.problemStatement))return;const a=((o=l.current)==null?void 0:o.value)||s.dataAnalysisObservations||"";if(a.trim()){w(!0),k(null),N(null);try{const i=(s.problemContext||"").trim(),y=[{role:"system",content:`You are an expert troubleshooting coach, skilled in many areas.
...
${a}`}],h=await fetch("https://multi-model-worker.study-llm.me/api/chat",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({model:"deepseek",messages:y,stream:!1})});if(!h.ok)throw new Error("Failed to analyze data");let c=((d=(t=(m=(await h.json()).choices)==null?void 0:m[0])==null?void 0:t.message)==null?void 0:d.content)||"";c=c.replace(/^```[\s\S]*?```/g,"").trim(),N(c)}catch{k("Failed to analyze data. Please try again.")}finally{w(!1)}}},K=async()=>{var o,m,t,d;if(!(s!=null&&s.problemStatement))return;const a=((o=l.current)==null?void 0:o.value)||s.dataAnalysisObservations||"";C(!0),E(null),g(null);try{const i=(s.problemContext||"").trim(),y=[{role:"system",content:`You are an expert troubleshooting coach, skilled in many areas.
