import{V as se,Y as ae,r as c,O as e,a3 as N,S as G,ah as ne,X as re,aa as H}from"./index-BQVrOF8L.js";import{M as ie}from"./MindMap-CjmZWZ6u.js";import{A as L}from"./alert-circle-D07m8tc4.js";import"./zoom-out-CNFOtpy0.js";import"./trash-2-C25xS5CF.js";const he=()=>{var E;const{id:K}=se(),{a3Cases:V,updateA3Case:m}=ae(),t=V.find(s=>s.id===K),[x,w]=c.useState(""),[j,S]=c.useState(!1),[A,y]=c.useState(null),[C,k]=c.useState(null),[M,I]=c.useState(!1),[O,b]=c.useState(null);c.useEffect(()=>{t&&t.rootCause!==x&&w(t.rootCause||"")},[t]),c.useEffect(()=>{if(!(t!=null&&t.mindMapNodes))return;const s=t.mindMapNodes;if(s.length===0)return;const n=s.filter(a=>!a.parentId);let r="";const i=(a,o)=>{const h=s.filter(l=>l.parentId===a);h.sort((l,d)=>l.y-d.y);for(const l of h){const d="  ".repeat(o);r+=`${d}- ${l.text}
