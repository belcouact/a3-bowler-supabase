import{c as F,W as q,Z as W,al as X,r,O as e,a6 as N,ai as A,S as D,X as R,am as T}from"./index-AItUWe6H.js";import{I as Z}from"./ImageCanvas-BK_PMZkF.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const z=F("Route",[["circle",{cx:"6",cy:"19",r:"3",key:"1kj8tv"}],["path",{d:"M9 19h8.5a3.5 3.5 0 0 0 0-7h-11a3.5 3.5 0 0 1 0-7H15",key:"1d8sl"}],["circle",{cx:"18",cy:"5",r:"3",key:"gq8acd"}]]),ae=()=>{const{id:L}=q(),{a3Cases:V,updateA3Case:h,isLoading:B}=W(),{user:n}=X(),a=V.find(s=>s.id===L),d=r.useRef(null),[k,p]=r.useState([]),[S,b]=r.useState(500),[C,I]=r.useState(!1),[f,y]=r.useState(null),[u,P]=r.useState(null),[O,H]=r.useState(!1),[v,w]=r.useState(null),[g,E]=r.useState(null),U=async s=>!a||!(n!=null&&n.username)?URL.createObjectURL(s):(await T.uploadA3Image(n.username,a.id,s)).url;r.useEffect(()=>{if(a){a.dataAnalysisImages&&JSON.stringify(a.dataAnalysisImages)!==JSON.stringify(k)&&p(a.dataAnalysisImages||[]),a.dataAnalysisCanvasHeight&&a.dataAnalysisCanvasHeight!==S&&b(a.dataAnalysisCanvasHeight);const s=a.dataAnalysisObservations||"";d.current&&d.current.value!==s&&(d.current.value=s)}},[a==null?void 0:a.id]),r.useEffect(()=>{if(!a||!(n!=null&&n.username)||Array.isArray(a.dataAnalysisImages)&&a.dataAnalysisImages.length>0)return;let i=!1;return(async()=>{try{const t=await T.loadA3Detail(n.username,a.id);if(!t||!t.success||i)return;const o={...a};let l=!1;Array.isArray(t.dataAnalysisImages)&&(p(t.dataAnalysisImages),o.dataAnalysisImages=t.dataAnalysisImages,l=!0),typeof t.dataAnalysisCanvasHeight=="number"&&(b(t.dataAnalysisCanvasHeight),o.dataAnalysisCanvasHeight=t.dataAnalysisCanvasHeight,l=!0),l&&h(o)}catch{}})(),()=>{i=!0}},[a==null?void 0:a.id,n==null?void 0:n.username,h]);const Y=s=>{p(s),a&&h({...a,dataAnalysisImages:s})},$=s=>{b(s),a&&h({...a,dataAnalysisCanvasHeight:s})},G=()=>{if(a&&d.current){const s=d.current.value;s!==a.dataAnalysisObservations&&h({...a,dataAnalysisObservations:s})}},K=async()=>{var i,m,t,o;if(!(a!=null&&a.problemStatement))return;const s=((i=d.current)==null?void 0:i.value)||a.dataAnalysisObservations||"";if(s.trim()){I(!0),P(null),y(null);try{const l=(a.problemContext||"").trim(),j=[{role:"system",content:`You are an expert troubleshooting coach, skilled in many areas.
