import{c as F,V as M,Y as q,ai as J,r,O as e,a3 as f,S as R,X as W,aj as T}from"./index-IbZS1YUW.js";import{I as X}from"./ImageCanvas-G1aLmG7u.js";import{A as D}from"./alert-circle-DUN51T_Q.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Z=F("Route",[["circle",{cx:"6",cy:"19",r:"3",key:"1kj8tv"}],["path",{d:"M9 19h8.5a3.5 3.5 0 0 0 0-7h-11a3.5 3.5 0 0 1 0-7H15",key:"1d8sl"}],["circle",{cx:"18",cy:"5",r:"3",key:"gq8acd"}]]),ae=()=>{var H;const{id:z}=M(),{a3Cases:L,updateA3Case:h}=q(),{user:n}=J(),s=L.find(a=>a.id===z),l=r.useRef(null),[b,x]=r.useState([]),[v,y]=r.useState(500),[j,w]=r.useState(!1),[A,N]=r.useState(null),[k,S]=r.useState(null),[I,C]=r.useState(!1),[P,g]=r.useState(null),[O,E]=r.useState(null),V=async a=>!s||!(n!=null&&n.username)?URL.createObjectURL(a):(await T.uploadA3Image(n.username,s.id,a)).url;r.useEffect(()=>{if(s){s.dataAnalysisImages&&JSON.stringify(s.dataAnalysisImages)!==JSON.stringify(b)&&x(s.dataAnalysisImages||[]),s.dataAnalysisCanvasHeight&&s.dataAnalysisCanvasHeight!==v&&y(s.dataAnalysisCanvasHeight);const a=s.dataAnalysisObservations||"";l.current&&l.current.value!==a&&(l.current.value=a)}},[s==null?void 0:s.id]),r.useEffect(()=>{if(!s||!(n!=null&&n.username)||Array.isArray(s.dataAnalysisImages)&&s.dataAnalysisImages.length>0)return;let o=!1;return(async()=>{try{const t=await T.loadA3Detail(n.username,s.id);if(!t||!t.success||o)return;const d={...s};let i=!1;Array.isArray(t.dataAnalysisImages)&&(x(t.dataAnalysisImages),d.dataAnalysisImages=t.dataAnalysisImages,i=!0),typeof t.dataAnalysisCanvasHeight=="number"&&(y(t.dataAnalysisCanvasHeight),d.dataAnalysisCanvasHeight=t.dataAnalysisCanvasHeight,i=!0),i&&h(d)}catch{}})(),()=>{o=!0}},[s==null?void 0:s.id,n==null?void 0:n.username,h]);const Y=a=>{x(a),s&&h({...s,dataAnalysisImages:a})},U=a=>{y(a),s&&h({...s,dataAnalysisCanvasHeight:a})},$=()=>{if(s&&l.current){const a=l.current.value;a!==s.dataAnalysisObservations&&h({...s,dataAnalysisObservations:a})}},B=async()=>{var o,m,t,d;if(!(s!=null&&s.problemStatement))return;const a=((o=l.current)==null?void 0:o.value)||s.dataAnalysisObservations||"";if(a.trim()){w(!0),S(null),N(null);try{const i=(s.problemContext||"").trim(),p=[{role:"system",content:`You are an expert troubleshooting coach, skilled in many areas.
