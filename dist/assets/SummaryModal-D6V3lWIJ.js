import{c as I,_ as O,O as e,S as m,U as v,X as T,Q as j,d as p,a_ as M}from"./index-Cd45AUo9.js";import{M as L}from"./MarkdownRenderer-DuWhHqO8.js";import{A as w}from"./alert-triangle-CkrPJ2bY.js";import{T as N}from"./target-DWEznBrV.js";import{C as k}from"./check-circle-2-DkTgAy-q.js";/**
 * @license lucide-react v0.330.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const F=I("Copy",[["rect",{width:"14",height:"14",x:"8",y:"8",rx:"2",ry:"2",key:"17jyea"}],["path",{d:"M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2",key:"zix9uf"}]]),_=({isOpen:C,onClose:u,content:i,isLoading:n,onHideWhileLoading:A,groupPerformanceTableData:d})=>{const b=O();if(!C)return null;let a=null,o=!1;try{if(i&&!n){const t=i.replace(/```json/g,"").replace(/```/g,"").trim();a=JSON.parse(t),a&&a.executiveSummary&&Array.isArray(a.areasOfConcern)&&(o=!0)}}catch{o=!1}const y=d.length>0,S=()=>{if(o&&a){let t=`Executive Overview:
${a.executiveSummary}
