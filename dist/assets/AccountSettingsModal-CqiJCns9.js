import{c as Fe,aF as Ye,Z as Ve,Y as Ke,r as a,O as e,X as Qe,aH as Xe,aI as Pe,aJ as q}from"./index-OJLlwzTi.js";import{generateAIContext as _e,generateComprehensiveSummary as et}from"./aiService-BdGNG9_S.js";import{L as se}from"./lock-CIJTh1Qg.js";import{C as tt}from"./check-BVv2x5WW.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const at=Fe("RefreshCw",[["path",{d:"M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8",key:"v9h5vc"}],["path",{d:"M21 3v5h-5",key:"1q7to0"}],["path",{d:"M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16",key:"3uifl3"}],["path",{d:"M8 16H3v5",key:"1cv678"}]]),it=({isOpen:m,onClose:Z,mode:f="account"})=>{const{user:r,refreshUser:ae}=Ye(),o=Ve(),{bowlers:J,a3Cases:R,selectedModel:$e,dashboardSettings:h,setDashboardSettings:S,dashboardMarkdown:Te,dashboardTitle:De,dashboardMindmaps:Ie,activeMindmapId:Re}=Ke(),[y,z]=a.useState("password"),[P,A]=a.useState(!1),[F,H]=a.useState(!1),[B,re]=a.useState(!1),[le,ne]=a.useState(!1),[Y,oe]=a.useState(""),[V,ie]=a.useState(""),[ce,de]=a.useState(""),[me,ue]=a.useState(""),[fe,he]=a.useState("China"),[pe,be]=a.useState("SZFTZ"),[xe,ge]=a.useState("GBS"),[$,ye]=a.useState(!0),[k,K]=a.useState(""),[p,Q]=a.useState(""),[v,X]=a.useState(""),[_,ze]=a.useState(""),[E,L]=a.useState(null),[N,ve]=a.useState("weekly"),[T,we]=a.useState(1),[D,je]=a.useState(1),[O,Se]=a.useState("08:00"),[U,ke]=a.useState(!1),[W,Ne]=a.useState(!1),[b,Ce]=a.useState("scheduled"),[G,Ae]=a.useState(!1),[ee,Ee]=a.useState(""),[M,Me]=a.useState(!1);if(a.useEffect(()=>{r&&(ue(r.role||""),he(r.country||"China"),be(r.plant||"SZFTZ"),ge(r.team||"GBS"),ye(r.isPublicProfile!==void 0?r.isPublicProfile:!0))},[r,m]),a.useEffect(()=>{if(!m){ke(!1),Ne(!1),Ae(!1);return}if(U)return;const t=h.emailSchedule;t&&((t.frequency==="weekly"||t.frequency==="monthly")&&ve(t.frequency),typeof t.dayOfWeek=="number"&&we(t.dayOfWeek),typeof t.dayOfMonth=="number"&&je(t.dayOfMonth),t.timeOfDay&&Se(t.timeOfDay)),ke(!0)},[m,h.emailSchedule,U]),a.useEffect(()=>{if(!m||W)return;const t=h.emailDefaults||{};k||(typeof t.recipients=="string"&&t.recipients.trim()!==""?K(t.recipients):r&&r.email&&K(r.email)),!p&&typeof t.subject=="string"&&t.subject.trim()!==""&&Q(t.subject),Ne(!0)},[m,h,W,k,p,r]),a.useEffect(()=>{m&&(f==="email"?z("email"):f==="account"&&y==="email"&&z("password"))},[m,f,y]),a.useEffect(()=>{if(!m||G)return;const t=h.emailConsolidate||{};typeof t.tags=="string"&&Ee(t.tags),typeof t.enabled=="boolean"&&Me(t.enabled),Ae(!0)},[m,h,G]),a.useEffect(()=>{m&&U&&S(t=>({...t,emailSchedule:{frequency:N,dayOfWeek:N==="weekly"?T:void 0,dayOfMonth:N==="monthly"?D:void 0,timeOfDay:O}}))},[N,T,D,O,m,U]),a.useEffect(()=>{m&&W&&S(t=>({...t,emailDefaults:{...t.emailDefaults||{},recipients:k,subject:p}}))},[k,p,m,W,S]),a.useEffect(()=>{m&&G&&S(t=>({...t,emailConsolidate:{...t.emailConsolidate||{},enabled:M,tags:ee}}))},[M,ee,m,G,S]),a.useEffect(()=>{m&&(v||h.latestSummaryForEmail&&(X(h.latestSummaryForEmail),h.latestSummaryHtmlForEmail?L(h.latestSummaryHtmlForEmail):L(null)))},[m,h.latestSummaryForEmail,v]),a.useEffect(()=>{m&&(p||Q("Monthly A3 / Bowler Summary"))},[m,p]),!m)return null;const He=async()=>{if(V!==ce){o.error("New passwords don't match");return}if(!Y){o.error("Please enter current password");return}A(!0);try{await Pe.changePassword({username:r==null?void 0:r.username,oldPassword:Y,newPassword:V}),o.success("Password updated successfully"),oe(""),ie(""),de("")}catch(t){o.error(t.message||"Failed to update password")}finally{A(!1)}},Be=async()=>{A(!0);try{await Pe.updateProfile({username:r==null?void 0:r.username,role:me,profile:{country:fe,plant:pe,team:xe,isPublic:$}}),o.success("Profile updated successfully");try{await ae()}catch(t){console.warn("Background refresh failed:",t)}}catch(t){o.error(t.message||"Failed to update profile")}finally{A(!1)}},Le=async()=>{A(!0);try{await ae(!0),o.success("Profile reloaded")}catch{o.error("Failed to reload profile")}finally{A(!1)}},Oe=async()=>{if(!r||!r.username){o.error("You must be logged in to cancel recurring emails");return}H(!0);try{const t={...h};"emailSchedule"in t&&delete t.emailSchedule,S(t),await q.saveData(J,R,r.username,Te,De,Ie,Re,t),o.success("Recurring email schedule cancelled")}catch(t){o.error(t.message||"Failed to cancel recurring schedule")}finally{H(!1)}},Ue=(t,l)=>{try{const d=t.replace(/```json/g,"").replace(/```/g,"").trim(),i=JSON.parse(d);if(!i||!i.executiveSummary)return t;let c=`Executive Overview:
${i.executiveSummary}
