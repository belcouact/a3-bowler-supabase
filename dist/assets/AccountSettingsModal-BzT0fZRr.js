import{c as pe,al as pt,_ as bt,Z as xt,r as l,O as e,X as Je,aP as gt,am as k,aQ as yt,aR as vt,aS as jt,aT as Ye}from"./index-jSbEkM29.js";import{L as he}from"./lock-CgLEnBsY.js";import{C as wt}from"./check-BJy44VDr.js";/**
...
`,i+=`----- | ------ | ------------ | ------------- | ------------- | ---------- | --------------------------
`,a.forEach(d=>{const x=d.latestMet===null||!d.latestActual?"—":d.latestActual,N=d.fail2?"Failing":"—",A=d.fail3?"Failing":"—",o=d.fail2||d.fail3?d.linkedA3Count===0?"0":String(d.linkedA3Count):"—",P=d.achievementRate!=null?`${d.achievementRate.toFixed(0)}%`:"—";i+=`${d.groupName} | ${d.metricName} | ${x} | ${N} | ${A} | ${o} | ${P}
`}),i+=`
...
</html>`}catch{return""}},Ze=async()=>{ye(!0);try{const t=yt(se,q),a=vt(se,q),n=a.filter(f=>f.fail2||f.fail3),i=`You are generating a one-click portfolio summary focused on improvement opportunities.
