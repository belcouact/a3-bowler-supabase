import{c as b,Y as z,O as e,S as m,Q as g,X as M,am as A}from"./index-CtXhf26x.js";import{M as F}from"./MarkdownRenderer-ySIFQTQm.js";import{a as h,A as u,T as O}from"./target-ZqunkGJH.js";/**
 * @license lucide-react v0.330.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const R=b("ArrowRight",[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"m12 5 7 7-7 7",key:"xquz4c"}]]);/**
 * @license lucide-react v0.330.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const T=b("Copy",[["rect",{width:"14",height:"14",x:"8",y:"8",rx:"2",ry:"2",key:"17jyea"}],["path",{d:"M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2",key:"zix9uf"}]]),E=({isOpen:y,onClose:x,content:i,isLoading:n,onHideWhileLoading:j,groupPerformanceTableData:d})=>{const p=z();if(!y)return null;let s=null,l=!1;try{if(i&&!n){const t=i.replace(/```json/g,"").replace(/```/g,"").trim();s=JSON.parse(t),s&&s.executiveSummary&&Array.isArray(s.areasOfConcern)&&(l=!0)}}catch{l=!1}const w=d.length>0,v=()=>{if(l&&s){let t=`Executive Overview:
${s.executiveSummary}
...
`}),navigator.clipboard.writeText(t)}else navigator.clipboard.writeText(i);p.success("Summary copied to clipboard!")},N=()=>{const t=c=>c.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;");let r="";if(l&&s){const c=t(s.executiveSummary),S=s.a3Summary&&s.a3Summary.trim()!==""?`<section class="card card-a3">
  <h2 class="card-title">A3 Problem Solving Summary</h2>
  <p>${t(s.a3Summary)}</p>
</section>`:"",C=d.length>0?`<section class="card card-stats">
    ...
    <table class="stats-table">
      ...
      <tbody>
        ${d.map(a=>`<tr>
          ...
          <td>${a.latestMet===null?"—":a.latestMet?'<span class="status-pill status-ok"><span class="status-dot"></span>ok</span>':'<span class="status-pill status-fail"><span class="status-dot"></span>fail</span>'}</td>
          ...
          <td>${a.achievementRate!=null?`${a.achievementRate.toFixed(0)}%`:"—"}</td>
        </tr>`).join("")}
      </tbody>
    </table>
  </div>
