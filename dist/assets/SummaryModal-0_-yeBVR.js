import{a1 as I,O as e,S as m,Y as v,X as O,W as j,P as w,d as p,b0 as T}from"./index-CGsjE4Ox.js";import{M}from"./MarkdownRenderer-D5qsP4rE.js";import{A as N}from"./alert-triangle-CtioqOVB.js";import{C as k}from"./check-circle-2-Bd2yribv.js";import{C as L}from"./copy-Jb5JWS4Z.js";const P=({isOpen:C,onClose:b,content:i,isLoading:n,onHideWhileLoading:A,groupPerformanceTableData:d})=>{const u=I();if(!C)return null;let a=null,o=!1;try{if(i&&!n){const t=i.replace(/```json/g,"").replace(/```/g,"").trim();a=JSON.parse(t),a&&a.executiveSummary&&Array.isArray(a.areasOfConcern)&&(o=!0)}}catch{o=!1}const y=d.length>0,S=()=>{if(o&&a){let t=`Executive Overview:
${a.executiveSummary}
...
`}),navigator.clipboard.writeText(t)}else navigator.clipboard.writeText(i);u.success("Summary copied to clipboard!")},$=()=>{const t=c=>c.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;");let s="";if(o&&a){const c=t(a.executiveSummary),h=a.a3Summary&&a.a3Summary.trim()!==""?`<section class="card card-a3">
  <h2 class="card-title">
