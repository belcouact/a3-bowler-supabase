          ...
          <div className="bg-white">
            ...
            <div className="px-3 py-2 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
              <div className="flex items-center gap-2.5">
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-indigo-500 to-blue-600 text-white shadow-lg shadow-blue-200">
              ...
              <button
                onClick={onClose}
                className="rounded-full p-1.5 text-slate-400 hover:bg-white hover:text-slate-600 transition-all hover:shadow-sm border border-transparent hover:border-slate-200"
                aria-label="Close"
              >
                <X className="w-4 h-4" />
              </button>
            ...
            {/* Navigation Tabs */}
            <div className="px-3 bg-white border-b border-slate-100">
              <nav className="-mb-px flex space-x-1 py-1">
                {[
                  ...
                  <button
                    ...
                    className={clsx(
                      "flex items-center gap-1.5 py-1.5 px-2.5 rounded-lg font-bold text-xs transition-all duration-200",
                      activeTab === tab.id
            ...
            <div className="px-3 py-3 min-h-[350px] max-h-[70vh] overflow-y-auto bg-white">
                {activeTab === 'General' && (
            ...
            {/* Footer */}
            <div className="px-4 py-3 bg-slate-50/80 border-t border-slate-100 flex flex-col sm:flex-row justify-between items-center gap-3">
               <div className="order-2 sm:order-1">
                 {initialData && onDelete && (
                   <button
                     type="button"
                     onClick={() => {
                       if(confirm('Are you sure you want to delete this bowler list?')) {
                         onDelete(initialData.id);
                         onClose();
                       }
                     }}
                     className="inline-flex items-center justify-center px-3 py-1.5 border border-transparent text-xs font-bold text-rose-600 bg-rose-50 hover:bg-rose-100 rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-rose-500 transition-all"
                   >
                     Delete Framework
                   </button>
                 )}
               ...
               <div className="flex items-center gap-3 w-full sm:w-auto order-1 sm:order-2">
                 <button
                   type="button"
                   onClick={onClose}
                   className="w-full sm:w-auto inline-flex justify-center items-center px-3 py-1.5 border border-slate-200 shadow-sm text-xs font-bold rounded-xl text-slate-700 bg-white hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all"
                 >
                   Cancel
                 </button>
                 <button
